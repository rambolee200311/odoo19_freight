...
This module is forked from OCA/currency repository, branch 19.0.
Custom extensions for tk_freight are implemented in the separate
``currency_rate_update_tk`` module.
